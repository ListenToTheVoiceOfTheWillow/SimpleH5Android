            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        Uri contentUri = FileProvider.getUriForFile(getContext(), (getContext().getPackageName() + ".fileprovider"), mTmpFile);
...
//                    intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(mTmpFile));
    ...
    private void requestPermission(final String permission0,final String permission1, String rationale, final int requestCode){
        if(shouldShowRequestPermissionRationale(permission0)&&shouldShowRequestPermissionRationale(permission1)){
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            requestPermissions(new String[]{permission0,permission1}, requestCode);
                        }
                    })
